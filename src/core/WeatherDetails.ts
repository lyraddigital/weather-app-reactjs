...
const weatherIdMessageMatrix: { [weatherId: number]: string } = {
    200: WeatherIdMessages.ThunderstormWithRain, 201: WeatherIdMessages.ThunderstormWithRain,
    202: WeatherIdMessages.ThunderstormWithRain, 210: WeatherIdMessages.LightThunderstorm,
    211: WeatherIdMessages.Thunderstorm, 212: WeatherIdMessages.StrongThunderstorm,
    221: WeatherIdMessages.StrongThunderstorm, 230: WeatherIdMessages.ThunderstormWithDrizzle,
    231: WeatherIdMessages.ThunderstormWithDrizzle, 232: WeatherIdMessages.ThunderstormWithDrizzle,
    300: WeatherIdMessages.LightDrizzle, 301: WeatherIdMessages.Drizzle,
    302: WeatherIdMessages.HeavyDrizzle, 310: WeatherIdMessages.LightDrizzle,
    311: WeatherIdMessages.Drizzle, 312: WeatherIdMessages.HeavyDrizzle,
    313: WeatherIdMessages.ShoweringAndDrizzle, 314: WeatherIdMessages.ShoweringAndDrizzle,
    321: WeatherIdMessages.ShoweringAndDrizzle, 500: WeatherIdMessages.LightRain,
    501: WeatherIdMessages.Rain, 502: WeatherIdMessages.HeavyRain,
    503: WeatherIdMessages.HeavyRain, 504: WeatherIdMessages.HeavyRain,
    511: WeatherIdMessages.FreezingRain, 520: WeatherIdMessages.LightRain,
    521: WeatherIdMessages.Rain, 522: WeatherIdMessages.HeavyRain,
    531: WeatherIdMessages.HeavyRain, 600: WeatherIdMessages.LightSnow,
    601: WeatherIdMessages.Snow, 602: WeatherIdMessages.HeavySnow,
    611: WeatherIdMessages.Sleet, 612: WeatherIdMessages.SleetAndShowers,
    613: WeatherIdMessages.SleetAndShowers, 615: WeatherIdMessages.RainAndSnow,
    616: WeatherIdMessages.RainAndSnow, 620: WeatherIdMessages.ShowersAndSnow,
    621: WeatherIdMessages.ShowersAndSnow, 622: WeatherIdMessages.ShowersAndSnow,
    701: WeatherIdMessages.Misty, 711: WeatherIdMessages.Smokey,
    721: WeatherIdMessages.Hazey, 731: WeatherIdMessages.Dusty,
    741: WeatherIdMessages.Foggy, 751: WeatherIdMessages.Sandy,
    761: WeatherIdMessages.Dusty, 762: WeatherIdMessages.VolcanicAsh,
    771: WeatherIdMessages.Windy, 781: WeatherIdMessages.Tornado,
    800: WeatherIdMessages.Clear, 801: WeatherIdMessages.FewClouds,
    802: WeatherIdMessages.ScatteredClouds, 803: WeatherIdMessages.Cloudy,
